...
export default function Footer() {
  return (
    <div id="footer">
      <p>
        <Link to="/">Home</Link> | <Link to="/furniture/categories">Furnitures</Link> | <Link to="/furniture/furnitures?calledFrom=newProducts">New Products</Link> | <Link to="/about">About Us</Link> | <Link to="/contacts">Contact Us</Link>
      </p>
      <p>
